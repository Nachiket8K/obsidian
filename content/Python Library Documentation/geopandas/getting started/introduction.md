...
source: "https://geopandas.org/en/latest/getting_started/introduction.html"
imported_from: "Python library documentation"
library: "geopandas"
---

This page was generated from [getting\_started/introduction.ipynb](https://github.com/geopandas/geopandas/blob/main/doc/source/getting_started/introduction.ipynb).

Interactive online version: [![Binder badge](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/geopandas/geopandas/main?urlpath=lab/tree/doc/source/getting_started/introduction.ipynb)
...
![geodataframe schema](../_images/dataframe.svg)
...
See more on [data structures](../docs/user_guide/data_structures.html) in the user guide.
...
See more on [reading and writing files](../docs/user_guide/io.html) in the user guide.
...
![../_images/getting_started_introduction_16_1.png](../_images/getting_started_introduction_16_1.png)
...
![../_images/getting_started_introduction_20_1.png](../_images/getting_started_introduction_20_1.png)
...
![../_images/getting_started_introduction_22_1.png](../_images/getting_started_introduction_22_1.png)
...
See more on [mapping](../docs/user_guide/mapping.html) in the user guide.
...
![../_images/getting_started_introduction_27_1.png](../_images/getting_started_introduction_27_1.png)
...
![../_images/getting_started_introduction_30_1.png](../_images/getting_started_introduction_30_1.png)

See more on [geometry manipulations](../docs/user_guide/geometric_manipulations.html) in the user guide.
...
![../_images/getting_started_introduction_32_0.svg](../_images/getting_started_introduction_32_0.svg)
...
![../_images/getting_started_introduction_40_1.png](../_images/getting_started_introduction_40_1.png)
...
![../_images/getting_started_introduction_44_1.png](../_images/getting_started_introduction_44_1.png)
...
See more on [projections](../docs/user_guide/projections.html) in the user guide.

## What next?

With GeoPandas we can do much more than what has been introduced so far, from [aggregations](../docs/user_guide/aggregation_with_dissolve.html), to [spatial joins](../docs/user_guide/mergingdata.html), to [geocoding](../docs/user_guide/geocoding.html), and [much more](../gallery/index.html).

Head over to the [user guide](../docs/user_guide.html) to learn more about the different features of GeoPandas, the [Examples](../gallery/index.html) to see how they can be used, or to the [API reference](../docs/reference.html) for the details.

On this page

[Show Source](../_sources/getting_started/introduction.ipynb.txt)

---

Original source: https://geopandas.org/en/latest/getting_started/introduction.html
