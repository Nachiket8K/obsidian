---
title: "Migration from PyGEOS geometry backend to Shapely 2.0"
source: "https://geopandas.org/en/latest/docs/user_guide/pygeos_to_shapely.html"
...
- The default backend is Shapely 2.0 and the PyGEOS is used only
  ...
  [installation instructions](../../getting_started/install.html).
...
[Migrating from PyGEOS](https://shapely.readthedocs.io/en/stable/migration_pygeos.html)
document for details.

On this page

[Show Source](../../_sources/docs/user_guide/pygeos_to_shapely.rst.txt)

---

Original source: https://geopandas.org/en/latest/docs/user_guide/pygeos_to_shapely.html
