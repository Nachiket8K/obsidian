---
title: "Set operations with overlay"
source: "https://geopandas.org/en/latest/docs/user_guide/set_operations.html"
...
the [`overlay()`](../reference/api/geopandas.GeoDataFrame.overlay.html#geopandas.GeoDataFrame.overlay "geopandas.GeoDataFrame.overlay") method.
...
[`GeoDataFrame`](../reference/api/geopandas.GeoDataFrame.html#geopandas.GeoDataFrame "geopandas.GeoDataFrame"), this operation is executed against every other shape in the right
[`GeoDataFrame`](../reference/api/geopandas.GeoDataFrame.html#geopandas.GeoDataFrame "geopandas.GeoDataFrame"):

![../../_images/overlay_operations.png](../../_images/overlay_operations.png)

**Source: QGIS documentation**

Note to users familiar with the *shapely* library: [`overlay()`](../reference/api/geopandas.GeoDataFrame.overlay.html#geopandas.GeoDataFrame.overlay "geopandas.GeoDataFrame.overlay") can be thought
...
*shapely* set operations are also available as [`GeoSeries`](../reference/api/geopandas.GeoSeries.html#geopandas.GeoSeries "geopandas.GeoSeries") methods.
...
[![../../_images/overlay_example.png](../../_images/overlay_example.png)](../../_images/overlay_example.png)

The above example illustrates the different overlay modes.
The [`overlay()`](../reference/api/geopandas.GeoDataFrame.overlay.html#geopandas.GeoDataFrame.overlay "geopandas.GeoDataFrame.overlay") method will determine the set of all individual geometries
...
For historical reasons, the overlay method is also available as a top-level function [`overlay()`](../reference/api/geopandas.overlay.html#geopandas.overlay "geopandas.overlay").
...
[![../../_images/overlay_example_union.png](../../_images/overlay_example_union.png)](../../_images/overlay_example_union.png)
...
[![../../_images/overlay_example_intersection.png](../../_images/overlay_example_intersection.png)](../../_images/overlay_example_intersection.png)
...
[![../../_images/overlay_example_symdiff.png](../../_images/overlay_example_symdiff.png)](../../_images/overlay_example_symdiff.png)
...
[![../../_images/overlay_example_difference.png](../../_images/overlay_example_difference.png)](../../_images/overlay_example_difference.png)
...
[![../../_images/overlay_example_identity.png](../../_images/overlay_example_identity.png)](../../_images/overlay_example_identity.png)
...
To illustrate the [`overlay()`](../reference/api/geopandas.GeoDataFrame.overlay.html#geopandas.GeoDataFrame.overlay "geopandas.GeoDataFrame.overlay") method, consider the following case in which one
...
[![../../_images/chicago_basic.png](../../_images/chicago_basic.png)](../../_images/chicago_basic.png)
[![../../_images/groceries_buffers.png](../../_images/groceries_buffers.png)](../../_images/groceries_buffers.png)
...
[![../../_images/chicago_cores.png](../../_images/chicago_cores.png)](../../_images/chicago_cores.png)
...
[![../../_images/chicago_peripheries.png](../../_images/chicago_peripheries.png)](../../_images/chicago_peripheries.png)

## keep\_geom\_type keyword

In default settings, [`overlay()`](../reference/api/geopandas.GeoDataFrame.overlay.html#geopandas.GeoDataFrame.overlay "geopandas.GeoDataFrame.overlay") returns only geometries of the same geometry type as GeoDataFrame
...
A larger set of examples of the use of [`overlay()`](../reference/api/geopandas.GeoDataFrame.overlay.html#geopandas.GeoDataFrame.overlay "geopandas.GeoDataFrame.overlay") can be found [here](https://nbviewer.jupyter.org/github/geopandas/geopandas/blob/main/doc/source/gallery/overlays.ipynb)

On this page

[Show Source](../../_sources/docs/user_guide/set_operations.rst.txt)

---

Original source: https://geopandas.org/en/latest/docs/user_guide/set_operations.html
