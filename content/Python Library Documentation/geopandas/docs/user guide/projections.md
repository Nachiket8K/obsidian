---
title: "Projections"
source: "https://geopandas.org/en/latest/docs/user_guide/projections.html"
...
GeoPandas can accept anything accepted by [`pyproj.CRS.from_user_input()`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS.from_user_input "(in pyproj v3.7.2)"):

- CRS WKT string
- An authority string (i.e. “epsg:4326”)
- An EPSG integer code (i.e. 4326)
- A [`pyproj.CRS`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS "(in pyproj v3.7.2)")
- An object with a to\_wkt method.
- PROJ string
...
Be aware that **most of the time** you don’t have to set a projection. Data loaded from a reputable source (using the [`geopandas.read_file()`](../reference/api/geopandas.read_file.html#geopandas.read_file "geopandas.read_file") command) *should* always include projection information. You can see an objects current CRS through the [`GeoSeries.crs`](../reference/api/geopandas.GeoSeries.crs.html#geopandas.GeoSeries.crs "geopandas.GeoSeries.crs") attribute.
...
latitude-longitude CRS to the [`GeoSeries.set_crs()`](../reference/api/geopandas.GeoSeries.set_crs.html#geopandas.GeoSeries.set_crs "geopandas.GeoSeries.set_crs") method (or by setting
the [`GeoSeries.crs`](../reference/api/geopandas.GeoSeries.crs.html#geopandas.GeoSeries.crs "geopandas.GeoSeries.crs") attribute):
...
![../../_images/usa_starting.png](../../_images/usa_starting.png)
![../../_images/usa_reproj.png](../../_images/usa_reproj.png)
...
stores the CRS information as a [`pyproj.CRS`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS "(in pyproj v3.7.2)"), and no longer as a proj4 string
or dict.
...
PROJ 6, but might also require some changes in your code. See [this blogpost](https://jorisvandenbossche.github.io/blog/2020/02/11/geopandas-pyproj-crs/)
for some more information. The subsections below cover different possible
migration issues.

See the [pyproj documentation](https://pyproj4.github.io/pyproj/stable/) for more on
the [`pyproj.CRS`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS "(in pyproj v3.7.2)") object.

### Importing data from files

When reading geospatial files with [`geopandas.read_file()`](../reference/api/geopandas.read_file.html#geopandas.read_file "geopandas.read_file"), things should
...
might not be fully as expected. See the [section below](#unrecognized-crs-reasons)
...
Further, on websites such as [Spatial Reference](https://spatialreference.org/)
and [epsg.org](https://epsg.org/) the descriptions of many CRS can be found
...
CRS: an actual [`pyproj.CRS`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS "(in pyproj v3.7.2)") object, a WKT string, a PROJ JSON string, etc.
Anything that is accepted by [`pyproj.CRS.from_user_input()`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS.from_user_input "(in pyproj v3.7.2)") can by specified
to the `crs` keyword/attribute in GeoPandas.

Also compatible CRS objects, such as from the [`rasterio`](https://rasterio.readthedocs.io/en/stable/api/rasterio.html#module-rasterio "(in rasterio)") package, can be
...
[`pyproj.CRS`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS "(in pyproj v3.7.2)") object that might not be fully what you expected (e.g. not equal
...
projection used in Belgium) as can be found at [EPSG:31370](https://spatialreference.org/ref/epsg/31370/)
...
[EPSG:2953](https://spatialreference.org/ref/epsg/2953/):
...
equivalent to the expected EPSG code. By lowering the min\_confidence, the axis
...
be broken given it is now a [`pyproj.CRS`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS "(in pyproj v3.7.2)") object. But this object actually
...
the [`to_epsg()`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS.to_epsg "(in pyproj v3.7.2)") method.
...
And there are many other methods available on the [`pyproj.CRS`](https://pyproj4.github.io/pyproj/stable/api/crs/crs.html#pyproj.crs.CRS "(in pyproj v3.7.2)") class to get
information about the CRS.

On this page

[Show Source](../../_sources/docs/user_guide/projections.rst.txt)

---

Original source: https://geopandas.org/en/latest/docs/user_guide/projections.html
