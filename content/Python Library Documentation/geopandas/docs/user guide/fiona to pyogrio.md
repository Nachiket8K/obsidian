---
title: "Migration from the Fiona to the Pyogrio read/write engine"
source: "https://geopandas.org/en/latest/docs/user_guide/fiona_to_pyogrio.html"
...
[Fiona](https://fiona.readthedocs.io) and
[Pyogrio](https://pyogrio.readthedocs.io).

It became possible to choose the engine using the `engine=` parameter in
[`geopandas.read_file()`](../reference/api/geopandas.read_file.html#geopandas.read_file "geopandas.read_file") and [`geopandas.GeoDataFrame.to_file()`](../reference/api/geopandas.GeoDataFrame.to_file.html#geopandas.GeoDataFrame.to_file "geopandas.GeoDataFrame.to_file"). It became also
...
With Pyogrio you can write an attribute table by using [`pyogrio.write_dataframe()`](https://pyogrio.readthedocs.io/en/stable/api.html#pyogrio.write_dataframe "(in pyogrio)")
...
[Show Source](../../_sources/docs/user_guide/fiona_to_pyogrio.rst.txt)

---

Original source: https://geopandas.org/en/latest/docs/user_guide/fiona_to_pyogrio.html
