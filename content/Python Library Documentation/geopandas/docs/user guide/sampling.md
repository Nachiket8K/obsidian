...
source: "https://geopandas.org/en/latest/docs/user_guide/sampling.html"
imported_from: "Python library documentation"
library: "geopandas"
---

This page was generated from [docs/user\_guide/sampling.ipynb](https://github.com/geopandas/geopandas/blob/main/doc/source/docs/user_guide/sampling.ipynb).

Interactive online version: [![Binder badge](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/geopandas/geopandas/main?urlpath=lab/tree/doc/source/docs/user_guide/sampling.ipynb)
...
```
30    MULTIPOINT ((1006269.138 257933.405), (1006214...
...
```
0    POINT (1006269.138 257933.405)
1    POINT (1006214.394 258056.842)
2     POINT (997428.647 217764.397)
3     POINT (994621.619 213755.595)
4     POINT (997034.095 217200.926)
Name: sampled_points, dtype: geometry
```
...
[Show Source](../../_sources/docs/user_guide/sampling.ipynb.txt)

---

Original source: https://geopandas.org/en/latest/docs/user_guide/sampling.html
