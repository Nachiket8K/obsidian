---
title: "Geocoding"
source: "https://geopandas.org/en/latest/docs/user_guide/geocoding.html"
...
location on Earth) through [geopy](http://geopy.readthedocs.io/), an optional dependency of GeoPandas.
...
![../../_images/boro_centers_over_bounds.png](../../_images/boro_centers_over_bounds.png)

By default, the [`geocode()`](../reference/api/geopandas.tools.geocode.html#geopandas.tools.geocode "geopandas.tools.geocode") function uses the
...
`'openmapquest'`, or an instance of a [`Geocoder`](https://geopy.readthedocs.io/en/stable/index.html#module-geopy.geocoders "(in GeoPy v2.4.1)") from [`geopy`](https://geopy.readthedocs.io/en/stable/index.html#module-geopy "(in GeoPy v2.4.1)"). See
`geopy.geocoders.SERVICE_TO_GEOCODER` for the full list.
For many providers, parameters such as API keys need to be passed as
`**kwargs` in the [`geocode()`](../reference/api/geopandas.tools.geocode.html#geopandas.tools.geocode "geopandas.tools.geocode") call.
...
([Photon’s Terms of Use](https://photon.komoot.io)).

[Show Source](../../_sources/docs/user_guide/geocoding.rst.txt)

---

Original source: https://geopandas.org/en/latest/docs/user_guide/geocoding.html
