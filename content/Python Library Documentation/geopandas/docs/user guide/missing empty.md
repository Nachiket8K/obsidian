---
title: "Missing and empty geometries"
source: "https://geopandas.org/en/latest/docs/user_guide/missing_empty.html"
...
- **Missing geometries** are unknown values in a GeoSeries. They will typically
  ...
  the intersection), or ignored in reductions such as [`union_all()`](geometric_manipulations.html#GeoSeries.union_all "GeoSeries.union_all").
...
separated. See [below](#missing-empty-changes-0-6-0) for more details
...
The [`GeoSeries.isna()`](../reference/api/geopandas.GeoSeries.isna.html#geopandas.GeoSeries.isna "geopandas.GeoSeries.isna") method will only check for missing values and not
...
you can use the [`GeoSeries.is_empty`](../reference/api/geopandas.GeoSeries.is_empty.html#geopandas.GeoSeries.is_empty "geopandas.GeoSeries.is_empty") attribute:
...
`np.nan`. At least, this was the case in [`GeoSeries.isna()`](../reference/api/geopandas.GeoSeries.isna.html#geopandas.GeoSeries.isna "geopandas.GeoSeries.isna") or when a
GeoSeries got aligned in geospatial operations. But, other methods like
`dropna()` and [`fillna()`](../reference/api/geopandas.GeoSeries.fillna.html#geopandas.GeoSeries.fillna "geopandas.GeoSeries.fillna") did not follow this
approach and did not consider empty geometries as missing.

In GeoPandas v0.6.0, the most important change is [`GeoSeries.isna()`](../reference/api/geopandas.GeoSeries.isna.html#geopandas.GeoSeries.isna "geopandas.GeoSeries.isna") no
...
Additionally, the behaviour of `GeoSeries.align()` changed to use
...
[Show Source](../../_sources/docs/user_guide/missing_empty.rst.txt)

---

Original source: https://geopandas.org/en/latest/docs/user_guide/missing_empty.html
