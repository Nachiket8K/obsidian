...
source: "https://geopandas.org/en/latest/getting_started.html"
...
[detailed instructions](getting_started/install.html).

### What now?

- If you don’t have GeoPandas yet, check [Installation](getting_started/install.html).
- If you have never used GeoPandas and want to get familiar with it and its core
  functionality quickly, see [Getting Started Tutorial](getting_started/introduction.html).
...
- And if you are interested in the complete
  ...
  [API Reference](docs/reference.html) is here for you.

[Installation](getting_started/install.html) [Introduction](getting_started/introduction.html)
[User Guide](docs/user_guide.html) [API Reference](docs/reference.html)
...
Original source: https://geopandas.org/en/latest/getting_started.html
