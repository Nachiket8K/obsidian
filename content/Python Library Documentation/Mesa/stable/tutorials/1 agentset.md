...
source: "https://mesa.readthedocs.io/stable/tutorials/1_agentset.html"
...
```
First 10 wealth values: [0, 3, 1, 0, 1, 1, 1, 0, 0, 0]
...
```
Average wealth — Green: 0.90, Blue: 0.72, Mixed: 1.31
```
...
```
Agents per ethnicity: {'Green': 29, 'Blue': 32, 'Mixed': 39}
```
...
```
  Green: 29 agents, avg wealth = 0.90
  Blue: 32 agents, avg wealth = 0.72
  Mixed: 39 agents, avg wealth = 1.31
```
...
```
Mean wealth by ethnicity: {'Green': np.float64(0.896551724137931), 'Blue': np.float64(0.71875), 'Mixed': np.float64(1.3076923076923077)}
```
...
```
Agents per wealth bracket: {'broke': 46, 'wealthy': 13, 'modest': 41}
```
...
Agents: 100
Total wealth: 146 (conserved: no, subsidy applied)
Wealth range: 1 to 7, mean: 1.46

By ethnicity:
  Green :  29 agents, avg wealth = 1.38, broke = 0
  Blue  :  32 agents, avg wealth = 1.19, broke = 0
  Mixed :  39 agents, avg wealth = 1.74, broke = 0
...
![../_images/dcaaeea92c09749463a0ca28e262022a1f655b430251a5562483936ed55592e5.png](../_images/dcaaeea92c09749463a0ca28e262022a1f655b430251a5562483936ed55592e5.png)
...
Original source: https://mesa.readthedocs.io/stable/tutorials/1_agentset.html
