...
source: "https://mesa.readthedocs.io/latest/tutorials/3_event_scheduling.html"
...
2. Executes your `step()` method
   For event-driven simulations, prefer these methods:
...
Notice that after `run_for(3)`, both the example’s `step_count` and `time` are at 3.
For standard step-based models, a user-defined step counter like this advances in
lockstep with time. But as we’ll see, events can fire
...
=== Central Bank Economy: Event Log ===
  ...
  t=  5.0 | Interest paid: 13 total
  t= 10.0 | Rate review: raised to 7% (avg wealth: 2.2)
  t= 10.0 | Interest paid: 39 total
  t= 15.0 | Interest paid: 41 total
  t= 20.0 | Rate review: raised to 9% (avg wealth: 1.3)
  t= 20.0 | Interest paid: 64 total
  t= 25.0 | *** STIMULUS: +5 to all citizens ***
  t= 25.0 | Interest paid: 67 total
  t= 30.0 | Rate review: raised to 11% (avg wealth: 2.6)
  t= 30.0 | Interest paid: 121 total
  t= 35.0 | Interest paid: 143 total
  t= 40.0 | Rate review: raised to 13% (avg wealth: 1.3)
  t= 40.0 | Interest paid: 192 total
  t= 45.0 | Interest paid: 219 total
  t= 50.0 | Rate review: raised to 15% (avg wealth: 0.8)
  t= 50.0 | Interest paid: 291 total

=== Final State (t=50) ===
Interest rate: 15%
Avg wealth: 0.8
Avg savings: 47.9
Total money in economy: 2439
```
...
- `generator.is_active` — Check if still running
  ...
  **Time tracking:** `model.time` (float), plus any user-defined counters you maintain in your model
...
Original source: https://mesa.readthedocs.io/latest/tutorials/3_event_scheduling.html
