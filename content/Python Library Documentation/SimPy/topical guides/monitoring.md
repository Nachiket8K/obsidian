---
title: "Monitoring"
source: "https://simpy.readthedocs.io/en/latest/topical_guides/monitoring.html"
...
- [Your processes](#monitoring-your-processes)?
- [Resource usage](#resource-usage)?
- [Trace all events of the simulation](#event-tracing)?
...
[`Environment.step()`](../api_reference/simpy.core.html#simpy.core.Environment.step "simpy.core.Environment.step"), where all events get processed, and
[`Environment.schedule()`](../api_reference/simpy.core.html#simpy.core.Environment.schedule "simpy.core.Environment.schedule"), where all events get scheduled and inserted
into SimPy’s event queue.

Here is an example that shows how [`Environment.step()`](../api_reference/simpy.core.html#simpy.core.Environment.step "simpy.core.Environment.step") can be patched in
...
Using the same concepts, you can also patch [`Environment.schedule()`](../api_reference/simpy.core.html#simpy.core.Environment.schedule "simpy.core.Environment.schedule").
...
e.g., their \_\_init\_\_() method in order to trace when and how an event is
initially being created.

---

Original source: https://simpy.readthedocs.io/en/latest/topical_guides/monitoring.html
