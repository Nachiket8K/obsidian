...
- [Sleep until woken up](#sleep-until-woken-up) (passivate/reactivate)
- [Waiting for another process to terminate](#waiting-for-another-process-to-terminate)
- [Interrupting another process](#interrupting-another-process)

The first two items were already covered in the [Events](events.html) guide, but we’ll
...
in a [separate guide](resources.html).
...
you can accomplish that with a simple, shared [`Event`](../api_reference/simpy.events.html#simpy.events.Event "simpy.events.Event"):
...
Again, nothing new (if you’ve read the [Events](events.html) guide) and special is
...
[Waiting for multiple events at once](events.html#waiting-for-multiple-events-at-once)).
...
`interrupt()` on a [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process"). This will throw an
[`Interrupt`](../api_reference/simpy.exceptions.html#simpy.exceptions.Interrupt "simpy.exceptions.Interrupt") exception into that process, resuming it
immediately:
...
[`Interruption`](../api_reference/simpy.events.html#simpy.events.Interruption "simpy.events.Interruption") event for immediate execution. If this
...
[`target`](../api_reference/simpy.events.html#simpy.events.Process.target "simpy.events.Process.target")). Following that it will throw the
...
Original source: https://simpy.readthedocs.io/en/latest/topical_guides/process_interaction.html
