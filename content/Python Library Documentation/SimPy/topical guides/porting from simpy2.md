---
title: "Porting from SimPy 2 to 3"
source: "https://simpy.readthedocs.io/en/latest/topical_guides/porting_from_simpy2.html"
...
import [`simpy`](../api_reference/simpy.html#module-simpy "simpy").
...
In SimPy 3, an [`Environment`](../api_reference/simpy.core.html#simpy.core.Environment "simpy.core.Environment") replaces `Simulation` and
[`RealtimeEnvironment`](../api_reference/simpy.rt.html#simpy.rt.RealtimeEnvironment "simpy.rt.RealtimeEnvironment") replaces `SimulationRT`. You always
need to instantiate an environment. There’s no more global state.

To execute a simulation, you call the environment’s
[`run()`](../api_reference/simpy.core.html#simpy.core.Environment.run "simpy.core.Environment.run") method.
...
level or as an instance method) wrapped in a [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process")
instance. The generator usually requires a reference to a
[`Environment`](../api_reference/simpy.core.html#simpy.core.Environment "simpy.core.Environment") to interact with, but this is completely
optional.

Processes are can be started by creating a [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process")
instance and passing the generator to it. The environment provides a shortcut
for this: [`process()`](../api_reference/simpy.core.html#simpy.core.Environment.process "simpy.core.Environment.process").
...
In SimPy 3, you directly yield [`events`](../api_reference/simpy.events.html#module-simpy.events "simpy.events") if you want to wait for an
event to occur. You can instantiate an event directly or use the shortcuts
provided by [`Environment`](../api_reference/simpy.core.html#simpy.core.Environment "simpy.core.Environment").
...
[`Timeout`](../api_reference/simpy.events.html#simpy.events.Timeout "simpy.events.Timeout") event.

[`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process") is also an [`Event`](../api_reference/simpy.events.html#simpy.events.Event "simpy.events.Event"). If
...
In SimPy 3, you call [`interrupt()`](../api_reference/simpy.events.html#simpy.events.Process.interrupt "simpy.events.Process.interrupt") on the victim
process. You can optionally supply a cause. An
[`Interrupt`](../api_reference/simpy.exceptions.html#simpy.exceptions.Interrupt "simpy.exceptions.Interrupt") is then thrown into the victim process,
...
a look at the other [guides](index.html), the [examples](../examples/index.html) or the [API Reference](../api_reference/index.html). You are also very
welcome to submit improvements. Just create a merge request at [GitLab](https://gitlab.com/team-simpy/simpy/).

---

Original source: https://simpy.readthedocs.io/en/latest/topical_guides/porting_from_simpy2.html
