...
them inherit [`simpy.events.Event`](../api_reference/simpy.events.html#simpy.events.Event "simpy.events.Event"). The listing below shows the
...
the [`simpy.events`](../api_reference/simpy.events.html#module-simpy.events "simpy.events") module. The [guide to resources](resources.html)
describes the various resource events.

## Event basics

SimPy events are very similar – if not identical — to deferreds, futures or
promises. Instances of the class [`Event`](../api_reference/simpy.events.html#simpy.events.Event "simpy.events.Event") are used to describe any kind
...
SimPy’s event queue. The property [`Event.triggered`](../api_reference/simpy.events.html#simpy.events.Event.triggered "simpy.events.Event.triggered") becomes `True`.
...
[`Event.callbacks`](../api_reference/simpy.events.html#simpy.events.Event.callbacks "simpy.events.Event.callbacks") list.
...
property [`Event.processed`](../api_reference/simpy.events.html#simpy.events.Event.processed "simpy.events.Event.processed") becomes `True`.

Events also have a *value*. The value can be set before or when the event is
triggered and can be retrieved via [`Event.value`](../api_reference/simpy.events.html#simpy.events.Event.value "simpy.events.Event.value") or, within a process, by
...
worked your way through the [tutorial](../simpy_intro/index.html).
...
If an event has been *processed*, all of its [`Event.callbacks`](../api_reference/simpy.events.html#simpy.events.Event.callbacks "simpy.events.Event.callbacks") have been
...
and pass an [`Exception`](https://docs.python.org/3/library/exceptions.html#Exception "(in Python v3.14)") instance to it (e.g., the exception you caught
...
events (even the basic [`Event`](../api_reference/simpy.events.html#simpy.events.Event "simpy.events.Event")) can be used.
...
SimPy processes (as created by [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process") or `env.process()`) have the
...
When a process is created, it schedules an [`Initialize`](../api_reference/simpy.events.html#simpy.events.Initialize "simpy.events.Initialize") event which will
...
can use [`simpy.util.start_delayed()`](../api_reference/simpy.util.html#simpy.util.start_delayed "simpy.util.start_delayed"). This method returns a helper
...
SimPy therefore offers the [`AnyOf`](../api_reference/simpy.events.html#simpy.events.AnyOf "simpy.events.AnyOf") and [`AllOf`](../api_reference/simpy.events.html#simpy.events.AllOf "simpy.events.AllOf") events which both
are a [`Condition`](../api_reference/simpy.events.html#simpy.events.Condition "simpy.events.Condition") event.
...
Original source: https://simpy.readthedocs.io/en/latest/topical_guides/events.html
