---
title: "SimPy basics"
source: "https://simpy.readthedocs.io/en/latest/topical_guides/simpy_basics.html"
...
The components involved in this are the [`Environment`](../api_reference/simpy.core.html#simpy.core.Environment "simpy.core.Environment"),
[`events`](../api_reference/simpy.events.html#module-simpy.events "simpy.events") and the process functions that you write.
...
yield instances of [`Event`](../api_reference/simpy.events.html#simpy.events.Event "simpy.events.Event").
...
a [`Timeout`](../api_reference/simpy.events.html#simpy.events.Timeout "simpy.events.Timeout") event. It passes the environment, a delay, and
...
accessible via the environment’s [`now`](../api_reference/simpy.core.html#simpy.core.Environment.now "simpy.core.Environment.now") attribute)
...
[`Environment`](../api_reference/simpy.core.html#simpy.core.Environment "simpy.core.Environment"), because you’ll need to pass it around a lot
...
1. You have to call the process function to create a generator object. (This
   ...
   yield keyword explained](http://stackoverflow.com/questions/231767/the-python-yield-keyword-explained/231855#231855),
   to understand why this is the case.)
2. You then create an instance of [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process") and pass the
   environment and the generator object to it. This will schedule an
   [`Initialize`](../api_reference/simpy.events.html#simpy.events.Initialize "simpy.events.Initialize") event at the current simulation time which
   ...
   [guide to events](events.html) explains why this is handy.
...
providing an `until` argument (see [Simulation control](environments.html#simulation-control)).
...
Original source: https://simpy.readthedocs.io/en/latest/topical_guides/simpy_basics.html
