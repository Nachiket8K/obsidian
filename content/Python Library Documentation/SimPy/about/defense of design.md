---
title: "Defense of Design"
source: "https://simpy.readthedocs.io/en/latest/about/defense_of_design.html"
...
capabilities, since dedicated libraries like [matplotlib](http://matplotlib.org/) or [PySide](http://qt-project.org/wiki/PySide) do
...
[`types.MethodType`](https://docs.python.org/3/library/types.html#types.MethodType "(in Python v3.14)") to the instance of `Environment` (or the resources,
respectively):
...
Original source: https://simpy.readthedocs.io/en/latest/about/defense_of_design.html
