...
source: "https://simpy.readthedocs.io/en/latest/simpy_intro/shared_resources.html"
...
SimPy offers three types of [`resources`](../api_reference/simpy.resources.html#module-simpy.resources "simpy.resources") that help you modeling
...
[`Resource`](../api_reference/simpy.resources.html#simpy.resources.resource.Resource "simpy.resources.resource.Resource") class.
...
The resource’s [`request()`](../api_reference/simpy.resources.html#simpy.resources.resource.Resource.request "simpy.resources.resource.Resource.request") method
...
[`release()`](../api_reference/simpy.resources.html#simpy.resources.resource.Resource.release "simpy.resources.resource.Resource.release") once you are done using
the resource.

When you release a resource, the next waiting process is resumed and now “owns”
one of the resource’s slots. The basic
[`Resource`](../api_reference/simpy.resources.html#simpy.resources.resource.Resource "simpy.resources.resource.Resource") sorts waiting processes in a *FIFO
(first in—first out)* way.

A resource needs a reference to an [`Environment`](../api_reference/simpy.core.html#simpy.core.Environment "simpy.core.Environment") and
...
You should now be familiar with SimPy’s basic concepts. The [next section](how_to_proceed.html) shows you how you can proceed with using SimPy from here on.

---

Original source: https://simpy.readthedocs.io/en/latest/simpy_intro/shared_resources.html
