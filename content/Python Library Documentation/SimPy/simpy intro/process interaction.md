...
source: "https://simpy.readthedocs.io/en/latest/simpy_intro/process_interaction.html"
...
The [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process") instance that is returned by
[`Environment.process()`](../api_reference/simpy.core.html#simpy.core.Environment.process "simpy.core.Environment.process") can be utilized for process interactions. The two
...
As it happens, a SimPy [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process") can be used like an event
...
yielding the [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process") instance that
[`Environment.process()`](../api_reference/simpy.core.html#simpy.core.Environment.process "simpy.core.Environment.process") returns, the `run` process starts waiting for
it to finish:
...
one (or more) cars and finally call [`run()`](../api_reference/simpy.core.html#simpy.core.Environment.run "simpy.core.Environment.run").
...
[`interrupt()`](../api_reference/simpy.events.html#simpy.events.Process.interrupt "simpy.events.Process.interrupt") method:
...
[`Interrupt`](../api_reference/simpy.exceptions.html#simpy.exceptions.Interrupt "simpy.exceptions.Interrupt") exceptions that can (should) be handled by
...
[Topical Guides](../topical_guides/index.html) or the [`Process`](../api_reference/simpy.events.html#simpy.events.Process "simpy.events.Process") API
reference for more details.

In the [next section](shared_resources.html) we will cover the basic usage of
shared resources.

---

Original source: https://simpy.readthedocs.io/en/latest/simpy_intro/process_interaction.html
